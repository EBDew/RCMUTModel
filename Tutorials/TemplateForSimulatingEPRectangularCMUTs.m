%Template script for simulating an EP rectangular CMUT (Electrode Posts):
...
CMUT.DeviceType = 'EP'; %Indicate CMUT architecture. Default "CD" = no posts. EP = Electrode posts. IIP = Isolated Isolation Posts.
