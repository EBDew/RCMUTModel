...
Our manuscript has been submitted to IEEE Transactions on Ultrasonics Ferrorelectrics and Frequency Control, and is still in the review process. This section will be updated as this process progresses.
...
@unpublished{Dew2024Small,
    ...
    year = "2024",
    note = "Submitted to IEEE transactions on ultrasonics, ferroelectrics, and frequency control." 
}
```
