...
The manuscript accompanying this project is available at [https://ieeexplore.ieee.org/document/11007609](https://ieeexplore.ieee.org/document/11007609). A bibtex entry for this article is available below.

```bibtex
@ARTICLE{dew2025small,
  ...
  title={Small-Signal Equivalent Circuit Model of Long Rectangular CMUT Membranes}, 
  year={2025},
  volume={5},
  number={},
  pages={82-102},
  doi={10.1109/OJUFFC.2025.3571698}
}
```

If you find this program useful for any academic works, please cite this manuscript. Additionally, the dynamic simulations generated by this program rely on radiation impedance models derived in [this article](https://www.mdpi.com/1424-8220/24/17/5823). Please also cite this manuscript in any works relying on these results.
